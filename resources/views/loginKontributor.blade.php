...
@section('content')
  ...
  <div class="col-6 d-flex align-items-center text-center">
    <div class="container">
      ...
      @endif
      <form action="{{ url('/loginKontributorPost') }}" method="post">
        {{ csrf_field() }}
      	<div class="form-group">
          <br><input type="email" class="form-control form-control-lg" id="email" name="email" placeholder="Email" required></input>
        </div>
        <div class="form-group">
          <input type="password" class="form-control form-control-lg" id="password" name="password" placeholder="Password" required></input><br>
        </div>
        <div class="form-group">
