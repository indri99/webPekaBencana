    ...
    <div class="container">
	  ...
	  <div class="row">
	    <div class="col-6">
		  ...
		  <a href="{{url ('/login-as-administrator') }}" class="btn" style="color: black">ADMINISTRATOR</a>
		</div>
		<div class="col-6">
		  <img src="/assets/img/asKontributor.png" height="265" width="265" style="max-width:100%;height:auto;">
		  <a href="{{url ('/login-as-kontributor') }}" class="btn" style="color: black">KONTRIBUTOR</a>
		</div>
	  </div>
	</div>
  </div>
